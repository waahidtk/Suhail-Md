		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: '🦋⃝❉⃟࿔ꦿScript🌹⃝✥⃟☺️᭄ꦿ',
                                    url: `${sc}`
                                }
                            }, {
                                urlButton: {
                                    displayText: '❤️⃟✦⃝̮̮̮̯̯̯😌YouTube🌹⃝⃘̉̉̉̉̉̉🧚📍',
                                    url: `${myweb}`
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '🎀۝⃟̥̩̩̩̥̩̥͚̮💍Menu🌹⃝⃘̉̉̉̉̉̉🧚🎀',
                                    id: 'menu'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤😮⃝৫⃟➤᭄᭄̊̊̊̊࿓࿔',
                                    id: 'owner'
                                },{
                                urlButton: {
                                    displayText: '🖤BLACK PANTHER GRUEP🖤',
                                    url: `https://chat.whatsapp.com/LWOdea4zvErAHkLNuAQkoP`
                                }
                            }]
                      let txt = `「 Black Panther  HERE🎉✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣ 」\n\n${text}`
...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'song': case 'ytplay': {
                ...
                let buttons = [
                    {buttonId: `ytmp3 ${anu.url}`, buttonText: {displayText: '꧁𝚂𝙾𝙽𝙶꧂'}, type: 1},
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '️꧁𝚅𝙸𝙳𝙴𝙾꧂'}, type: 1}
                ]
                let buttonMessage = {
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: '🌹⃝✥⃟☺️᭄ꦿYouTube📍😒⃟🌹⃟̩̩̩̥ꦿ࿓',
                                    url: `${myweb}`
                                }
                            }, {
                            	urlButton: {
...
♪♫•*¨*•.¸¸❤¸¸.•*¨*•♫♪
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: '😒࿔⃝༒⃝❤️᭄YouTube😮⃝৫⃟➤᭄᭄̊̊̊̊࿓࿔📍',
                                    url: `${myweb}`
                                }
                            }, {
                            	urlButton: {
                                displayText: '🦋⃝❉⃟࿔ꦿ ULTRA MD ✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣',
                                    url: `${sc}`
                                }
                                }, {
                                quickReplyButton: {
                                ...
                                quickReplyButton: {
                                    displayText: 'Owner🐦✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣',
                                    id: `${prefix}owner`
                                }
                            }]
                        }
    ...
    const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: '😌⃟⌘࿔⃝❤️YouTube😒࿔⃝༒⃝❤️᭄📍',
                                    url: `${myweb}`
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner🌹⃝✥⃟☺️᭄ꦿ',
                                    id: `${prefix}owner`
                                }
                            }]
                        }
